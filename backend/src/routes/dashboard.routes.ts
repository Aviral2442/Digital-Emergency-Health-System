...
import { bookingDashboardCountsController, policeDashboardCountsController, driverDashboardCountsController, hospitalDashboardCountsController } from '../controllers/dashboard.controller';
const router = Router();
